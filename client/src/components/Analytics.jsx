    ...
    return (
        <>
            ...
            <div className="row m-3">
                ...
                {/* category */}
                <div className="col-md-3">
                    <h4 style={{ color: "white" , background :"green",padding:"10px", borderRadius:"15px"}}>Categorywise Income</h4>
                ...
                <div className="col-md-3">
                    <h4 style={{ color: "white" ,background :"red",padding:"10px",borderRadius:"15px"}}>Categorywise Expense</h4>
                    {categories.map((category) => {
                        const amount = allTransection
                            .filter(
                                (transaction) =>
